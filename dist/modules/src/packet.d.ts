...
export declare const validatePacketRetrievalOptions: (options: PacketRetrievalOptions) => void;
export declare const validateTimestamp: (timestamp: number) => void;
/**
 * Reads packets from an InputTrack. Adapted for the HLS branch's promise-based InputTrackBacking interface.
 */
export declare class PacketReader<T extends InputTrack = InputTrack> {
    track: T;
    constructor(track: T);
