...
export declare class AsyncMutexLock implements Disposable {
    private readonly mutex;
    readonly pending: boolean;
    readonly ready: Promise<void> | null;
    private released;
    constructor(mutex: AsyncMutex, pending: boolean, ready: Promise<void> | null);
    release(): void;
    [Symbol.dispose](): void;
}
...
export declare class ResultValue<T> {
    value: T;
    pending: boolean;
    set(value: T): ReturnSymbol;
    reset(): void;
}
export declare class NaiveCallSerializer {
    currentPromise: Promise<void>;
    errored: boolean;
    call(fn: () => Promise<void> | void): Promise<void>;
}
export declare class ForgivingCallSerializer {
    private currentPromise;
    private queuedCalls;
    call<T>(fn: () => T): T extends Promise<any> ? T : T | Promise<T>;
    waitUntilIdle(): Promise<void> | null;
    isIdle(): boolean;
}
export declare class AsyncGate {
    resolvers: (() => void)[];
    wait(): Promise<void>;
    open(): void;
}
export declare const defer: (callback: () => void) => {
    execute(): void;
    [Symbol.dispose](): void;
};
