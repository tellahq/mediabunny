...
import { isNumber, SECOND_TO_MICROSECOND_FACTOR } from './misc.js';
...
export const validatePacketRetrievalOptions = (options) => {
...
export class PacketReader {
    ...
    _maybeVerifyPacketType(packet, options) {
    ...
    getFirst(options = {}) {
        ...
        return this.track._backing.getFirstPacket(options)
            .then(p => this._maybeVerifyPacketType(p, options));
    }
    getAt(timestamp, options = {}) {
    ...
    async _readKeyAtVerified(timestamp, options) {
    ...
    async _getNextKeyVerified(from, options) {
