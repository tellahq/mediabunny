...
import { concatAvcNalUnits, deserializeAvcDecoderConfigurationRecord, determineVideoPacketType, extractNalUnitTypeForAvc, extractNalUnitTypeForHevc, HevcNalUnitType, iterateAvcNalUnits, iterateHevcNalUnits, parseAvcSps, sanitizeHevcPacketForChromium, } from './codec-data.js';
...
export class VideoDecoderWrapper extends DecoderWrapper {
    constructor(onSample, onError, codec, decoderConfig, rotation, timeResolution) {
        ...
        this.customDecoderClosed = false;
...
export class AudioDecoderWrapper extends DecoderWrapper {
...
export class PcmAudioDecoderWrapper extends DecoderWrapper {
