 ...
 */
import { PcmAudioCodec, VideoCodec, AudioCodec } from './codec.js';
import { CustomVideoDecoder, CustomAudioDecoder } from './custom-coder.js';
import { InputAudioTrack, InputTrack, InputVideoTrack } from './input-track.js';
import { AnyIterable, CallSerializer, Rotation } from './misc.js';
...
export declare abstract class DecoderWrapper<MediaSample extends VideoSample | AudioSample> {
...
export declare class VideoDecoderWrapper extends DecoderWrapper<VideoSample> {
    codec: VideoCodec;
...
export declare class AudioDecoderWrapper extends DecoderWrapper<AudioSample> {
...
export declare class PcmAudioDecoderWrapper extends DecoderWrapper<AudioSample> {
