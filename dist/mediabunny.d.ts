 ...
 * @public
 */
export declare const canvasTransformer: (options?: CanvasTransformerOptions) => SampleTransformer<VideoSample, WrappedCanvasV2>;

/**
 * Options for constructing a canvas transformer to be used with {@link VideoSampleCursor}.
 * @public
 */
export declare type CanvasTransformerOptions = {
    /**
     * Whether the output canvases should have transparency instead of a black background. Defaults to `false`. Set
 ...
 * @public
 */
export declare class DashInputFormat extends InputFormat {
    get name(): string;
    get mimeType(): string;
}
 ...
 * @public
 */
export declare type SampleCursorOptions<Sample, TransformedSample> = {
    autoClose?: boolean;
 ...
 * @public
 */
export declare type SampleTransformer<Sample, TransformedSample> = (sample: Sample) => TransformedSample;
 ...
 * @public
 */
export declare class WrappedCanvasV2 {
    /** A canvas element or offscreen canvas. */
    canvas: HTMLCanvasElement | OffscreenCanvas;
    /** The timestamp of the corresponding video sample, in seconds. */
    timestamp: number;
